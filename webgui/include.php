...
$header .= "<li class=\"nav-label first\">Menu</li>\n";
...
$header .= "<li><a href=\"./index.php\">Main Dashboard</a></li>\n";
$header .= "<li><a href=\"./index_blue.php\">Blue Team Dashboard</a></li>\n";
$header .= "<li><a href=\"./index_red.php\">Red Team Dashboard</a></li>\n";
$header .= "</ul>\n";
$header .= "</li>\n";
$header .= "<li class=\"nav-label\">Apps</li>\n";
$header .= "<li><a class=\"has-arrow\" href=\"javascript:void()\" aria-expanded=\"false\"><i class=\"icon icon-app-store\"></i><span class=\"nav-text\">Recon Apps</span></a>\n";
$header .= "<ul aria-expanded=\"false\">\n";
